...
public:
	...
	Array(int size = 2) : logicalSize(0), phisicalSize(size) { arr = new T[phisicalSize]; }
	Array(const Array& other) : arr(NULL) { *this = other; }
	~Array() { delete[]arr; }
...
int main()
{
	...
	Array<int>::iterator itr = v1.begin();
	Array<int>::iterator itrEnd = v1.end();
	for (; itr != itrEnd; ++itr)
		cout << *itr << " ";
	cout << endl;
