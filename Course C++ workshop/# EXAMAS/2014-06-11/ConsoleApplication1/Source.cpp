...
int main()
{
	Array<int> intArr1(5), intArr2(10);
	Array<char*> strArr1(3), strArr2(3);
	intArr1[0] = (int)(intArr2[0] = 1);//explicit again :(
	strArr1[0] = (char*)(strArr2[0] = "Hello");
	intArr2[1] = 2;
	strArr1 = strArr2;
	strArr2[1] = " world!";
	intArr2 = intArr1;
	cout << intArr2[0] << ", " << intArr2[1] << endl;
	cout << strArr2[0] << strArr2[1] << endl;
	return 1;//notice it is not 0
}//main
