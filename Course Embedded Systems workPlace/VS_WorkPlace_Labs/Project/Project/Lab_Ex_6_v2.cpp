...
void smapling(unsigned int chosed_scanned_port_b_bits);
void analog1();
void analog2();
void analog3();
...
void smapling(unsigned int chosed_scanned_port_b_bits)
{
	...
	AD1CHS = chosed_scanned_port_b_bits; // in this example RB8/AN8 is the input
...
void analog1()
{
	...
	smapling(0x00080000);//ADCValue calculated inside
...
void analog2()
{
	...
	smapling(0x00090000);//ADCValue calculated inside
...
void analog3()
{
	...
	digitalVal = (ADCValue / 4);//compression for D/A 
