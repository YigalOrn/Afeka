/*
Present a string of chars on the LCD and
make the presented text move on the LCD
*/
...
void main(void)
{
	...
	do
	{
		for (i = 0; i < 16; i++)
		{
			...
			it is a display shift, each shift command to LCD is by one char and it is controlled by the for loop!!!
